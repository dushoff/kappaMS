...
%\begin{figure}
%\centering
%\includegraphics{kappa/rcHist.Rout.pdf}
%\caption{Identical distributions of cases per case for epidemics of different strength conditioned over the entire outbreak cycle.
	%We simulate epidemic outbreaks for a population of $10000$  and  collect data on the case per case over the entire outbreak cycle. 
 %The case-per-case distribution over the entire outbreak is independent of \Ro.
%}\flab{rcHist}
%\end{figure}
...
%\caption{
%Different compositions of variance in cases per case for epidemics of different strengths.
...
\begin{figure}
\centering
\includegraphics{Fig2and3.Rout.pdf}
\caption{
Identical distributions of cases per case for epidemics of different strength conditioned over the entire outbreak cycle.
Top panel. We simulate epidemic outbreaks for a population of $10000$  and  collect data on the case per case over the entire outbreak cycle. 
 The case-per-case distribution over the entire outbreak is independent of \Ro.
Lower panel. Different compositions of variance in cases per case for epidemics of different strengths.
As  \Ro grows, between-cohort variation increases while within-cohort variation decreases, so that the total variance in cases per case remains constant.
}\flab{fig2and3}
\end{figure}
...
The top panel of \fref{fig2and3} shows realized distributions of ``offspring cases'' caused by individual infectors across a simple, stochastic SIR epidemic. The distributions remain indistinguishable across a wide range of the key parameter \Ro.
