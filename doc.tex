...
\begin{figure}[H]
	...
	\caption{
		...
		Panel a: Cohort size infected during $[t,t+\Delta t]$ is measured as the area under the incidence curve over this interval ($\Delta t =2\times 10^{-3}t_{\mathrm{peak}}$, where $t_{\mathrm{peak}}$ is the time of peak incidence).
