...
Real outbreaks have significant heterogeneity in secondary case distributions -- including ``superspreading,'' marked by a small fraction of individuals causing a disproportionately large fraction of realized transmission~[\tb{Lloyd-Smith2005, Woolhouse1997,10.1038/s41591-020-1092-0}].
Several distinct factors influence the emergence of superspreaders and disproportionately impact the outbreak [\tb{10.1371/journal.pcbi.1009980, 10.1093/pnasnexus/pgaf299}].
...
Furthermore, control efforts that account for superspreaders may be more effective [\tb{Garske2008, 10.1038/s41467-023-42612-9, 10.1073/pnas.2016623118}]. 
Superspreading may be most salient for disease dynamics and control strategies at the time of outbreak [\tb{Goyal2022}]. % see if this is actually the reference we want here
...
Theoretical treatment of superspreading has focused on effective, non-mechanistic models that link observed secondary case counts to a continuous random variable, the ``individual reproduction number,'' via a Poisson sampling process~[\tb{Lloyd-Smith2005}].
...
In practice, epidemiological modelers also include \emph{explicit heterogeneity} into their models, for example by considering age- or spatially-explicit compartments that may have different expected rates of mixing, transmission, or recovery [\tb{Schenzle1984}].
Explicit heterogeneity reproduces superspreading in linear compartmental models [\tb{Meehan2023}].
