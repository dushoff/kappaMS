...
\begin{figure}[H]
	...
	\caption{\textbf{The susceptible population changes during an outbreak.} Outbreaks with higher \Ro~values lead to greater variation in incidence and more rapid depletion of the susceptible pool. We modeled these outbreaks using a deterministic compartmental approach.}
	\flab{SIRsim}
\end{figure}
...
\begin{figure}[H]
	...
	\caption{
		\textbf{Cohorts' secondary-case statistics.} 
		...
		In Panel b, the mean and standard deviation of secondary cases associated with each cohort are plotted.	
		%	In an
